<template>
    <header>
        <div class="header-content" :class="[ qrccode, changeClass ]">
            ...
            <div class="header-content-right icon">
                <!-- Article Page -->
                <template v-if="like">
...
export default {
    ...
    mounted(){
        ...
        const o = {
            articlePage: () => {
                ...
                this.isLike = !!localStorage.getItem(`like-${this.id}`)
            },
            sticky: () => {
    ...
    methods: {
        gettersUserInfo(){
            ...
            if(_userInfo){
               this.user_info = JSON.parse(_userInfo) 
            }
        },
        ...
        touch(e){
            ...
            // Wechat code
            if (className == "iconfont icon-weixin") {
